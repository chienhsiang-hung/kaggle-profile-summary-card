...
url_svg = 'https://www.kaggle.com/static/images/site-logo.svg'
resp = requests.get(url, stream=True)
resp_svg = requests.get(url_svg)
...
<svg width="540" height="250" xmlns="http://www.w3.org/2000/svg" xmlns:svg="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
 ...
 <g class="layer">
  ...
  <image height="41.46" id="svg_2" width="123" x="13" xlink:href="data:img/png; utf8,'''+resp_svg.text+'''" y="15"/>
