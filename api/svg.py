    ...
    if not colorAchieve:
      ...
      html = '''
        ...
        <g class="layer">
          ...
          <text fill="#333333" font-family="Sans-serif" font-size="17" id="svg_14" stroke="#666666" stroke-linecap="round" stroke-linejoin="round" stroke-width="0" text-anchor="start" transform="matrix(1 0 0 1 0 0)" x="189" xml:space="preserve" y="137">'''+occupation+'''</text>
