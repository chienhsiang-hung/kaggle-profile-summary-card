...
class handler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        <g class="layer">
          ...
          <image height="41.46" id="svg_2" width="123" x="13" xlink:href="'''
                + util.kaggle_svg_dataurl
                + """ y="15"/>
      ...
      """
        ...
        <g class="layer">
          ...
          <image height="104" id="svg_3" transform="matrix(1 0 0 1 0 0)" width="104" x="422" xlink:href="data:image/png; base64,"""
              + userAchieveUrl
              + """" y="78"/>
          <image height="41.46" id="svg_2" width="123" x="13" xlink:href='''"
          + util.kaggle_svg_dataurl
          + '''" y="15"/>
          <line fill="none" id="svg_7" stroke="#000000" stroke-linecap="round" stroke-linejoin="round" transform="matrix(1 0 0 1 0 0)" x1="7" x2="534" y1="65" y2="66"/>
          <image height="171" id="svg_10" transform="matrix(1 0 0 1 0 0)" width="171" x="6" xlink:href="data:image/png; base64,"""
              + userAvatarUrl
              + """" y="71"/>
          <text fill="#000000" font-family="Sans-serif" font-size="19" font-weight="bold" id="svg_12" stroke="#666666" stroke-linecap="round" stroke-linejoin="round" stroke-width="0" text-anchor="start" transform="matrix(1 0 0 1 0 0)" x="189.67" xml:space="preserve" y="106">"""
              + displayName
              + """</text>
          <text fill="#333333" font-family="Sans-serif" font-size="17" id="svg_14" stroke="#666666" stroke-linecap="round" stroke-linejoin="round" stroke-width="0" text-anchor="start" transform="matrix(1 0 0 1 0 0)" x="189" xml:space="preserve" y="137">"""
              + occupation
              + """</text>
          <text fill="#333333" font-family="Sans-serif" font-size="17" id="svg_15" stroke="#666666" stroke-linecap="round" stroke-linejoin="round" stroke-width="0" text-anchor="start" x="189.67" xml:space="preserve" y="178">"""
              + city
              + """, """
              + country
              + """</text>
          <text fill="#999999" font-family="Sans-serif" font-size="14" id="svg_1" stroke="#666666" stroke-linecap="round" stroke-linejoin="round" stroke-width="0" text-anchor="start" transform="matrix(1 0 0 1 0 0)" x="189" xml:space="preserve" y="217">Joined at """
              + userJoinDate
              + """</text>
          <text fill="'''+colorAchieve+'''" font-family="Sans-serif" font-size="16" font-weight="bold" id="svg_5" stroke="#000000" stroke-linecap="round" stroke-linejoin="round" stroke-width="0" text-anchor="middle" transform="matrix(1 0 0 1 0 0)" x="474" xml:space="preserve" y="204">"""
              + performanceTierCategory
              + """</text>
          <text fill="'''+colorAchieve+'''" font-family="Sans-serif" font-size="16" font-weight="bold" id="svg_8" stroke="#000000" stroke-linecap="round" stroke-linejoin="round" stroke-width="0" text-anchor="middle" x="472.95" xml:space="preserve" y="225.5">"""
              + performanceTier
              + """</text>
        </g>
        </svg>
